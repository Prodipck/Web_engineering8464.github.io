...
function quizQuestion() {
	...
	var Option1 = document.querySelector('input[name="1"]:checked').value;
	var Option2 = document.querySelector('input[name="2"]:checked').value;
	var Option3 = document.querySelector('input[name="3"]:checked').value;
	var Option4 = document.querySelector('input[name="4"]:checked').value;
	var Option5 = document.querySelector('input[name="5"]:checked').value;
	...
	if (Option1 == 'a') {
		...
		document.getElementById('ans1').innerHTML = "INCORRECT: the correct answer is A) DHAKA"
	}
	...
	if (Option2 == 'b') {
		...
		document.getElementById('ans2').innerHTML = "INCORRECT: the correct answer is B) TAKA"
	}
	...
	if (Option3 == 'b') {
		...
		document.getElementById('ans3').innerHTML = "INCORRECT: the correct answer is B) France"
	}
	...
	if (Option4 == 'c') {
		...
		document.getElementById('ans4').innerHTML = "INCORRECT: the correct answer is B) England"
	}
	...
	if (Option5 == 'c') {
		...
		document.getElementById('ans5').innerHTML = "INCORRECT: the correct answer is C) 1901"
	}
    
    var prs= (i/5)*100
	document.getElementById('result').innerHTML = "You answered "+i+" out of 5 questions correctly and you answered "+prs+"% correctly"
